...
(function ($, Drupal) {
  ...
  Drupal.behaviors.EditInPlaceFieldReferenceForm = {
    attach: function (context) {
      $(once("editInPlaceEditBehavior", ".edit-in-place-clickable .edit-in-place-editable")).click(function(e){
      ...
      $(once("editInPlaceCancelBehavior", ".edit-in-place-cancel")).click(function(e){
        e.stopPropagation();
        e.preventDefault();
