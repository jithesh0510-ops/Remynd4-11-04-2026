...
namespace Drupal\social_auth_microsoft;
...
/**
 * Contains all the logic for Microsoft OAuth2 authentication.
 */
class MicrosoftAuthManager extends OAuth2Manager {
  ...
  public function __construct(
    ...
    parent::__construct(
      $config_factory->get('social_auth_microsoft.settings'),
      $logger_factory,
  ...
  public function getUserInfo(): SocialAuthUserInterface {
    if (!$this->user) {
      /** @var \Stevenmaguire\OAuth2\Client\Provider\MicrosoftResourceOwner $owner */
   ...
   * {@inheritdoc}
   *
   * @todo Update for v2.0 endpoints.
   *
