...
class EmployeeImportForm extends FormBase {
  ...
  /**
   * Company dropdown options (role=company).
   * Shows company NAME (from company profile fields), not email / Company #ID.
   */
  /**
   * Company dropdown options (role=company).
   * Shows company NAME (from company profile fields), not email / Company #ID.
  ...
  /**
   * Find a human company name from the company user's profile entity.
   * Falls back to username if nothing else exists.
   */
  /**
   * Find a human company name from the company user's profile entity.
   * Falls back to username if nothing else exists.
  ...
  /**
   * Find a human company name from the company user's profile entity.
   * Falls back to username/display name if nothing else exists.
   */
